...
//     version 1.14.0
//     from Assets/Card Havoc/Runtime/InputSystem/CardHavocControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Card Havoc/Runtime/InputSystem/CardHavocControls.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @CardHavocControls: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @CardHavocControls()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""CardHavocControls"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@CardHavocControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, CardHavocControls.Player.Disable() has not been called.");
    }
    ...
    {
        private @CardHavocControls m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@CardHavocControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
